...
export default async function middleware(request: NextRequest) {
  ...
  const cspValue = [
    ...
    "connect-src 'self' https://auth.foryoupiece.com https://*.supabase.co https://api.boxhero.io https://accounts.google.com https://oauth2.googleapis.com https://graph.facebook.com https://www.facebook.com https://telegram.org https://oauth.telegram.org https://capig.foryoupiece.com wss://auth.foryoupiece.com wss://*.supabase.co",
